        ...
        if self._hole_stats["with_holes"] > 0:
            ...
            if self._hole_fix_policy == "fill":
                summary_lines.append(self.tr(
                    "Polygon holes: filled {0} of {1} feature(s) with holes "
                    "(area grows by the hole)."
                ).format(self._hole_stats["fixed"], self._hole_stats["with_holes"]))
            elif self._hole_fix_policy == "cut":
                summary_lines.append(self.tr(
                    "Polygon holes: cut {0} of {1} feature(s) with holes "
                    "(area preserved)."
                ).format(self._hole_stats["fixed"], self._hole_stats["with_holes"]))
            else:
                summary_lines.append(self.tr(
                    "Polygon holes: {0} feature(s) with holes left as-is (flagged)."
                ).format(self._hole_stats["with_holes"]))
            if self._hole_stats["flagged"] > 0:
                summary_lines.append(self.tr(
                    "  {0} feature(s) could not be fixed and were left flagged."
                ).format(self._hole_stats["flagged"]))
